<div class="modal" id="deleteMovieModal" tabindex="-1"> <!-- ID1 deleteMovieModal -->
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Are you sure that you want to delete the movie <span id="movieTitle"></span>?</p> <!-- ID2 movieTitle -->
      </div>
